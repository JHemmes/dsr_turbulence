...
def learn(sessions, controllers, pool,
    ...
    for step in range(n_epochs):
        ...
        # actions = [np.array([7, 7, 7, 9, 13, 3, 12, 4, 11, 10, 0,5,12,0]),np.array([7, 7, 7, 9, 0, 3, 12, 4, 11, 10, 0,5,12,0])]
        # actions = np.array([[ 7,  1,  4,  4,  2, 10,  3,  2,  9,  2,  9,  6,  3, 10,  8,  7,
        #          6,  2, 13,  1,  5, 13,  0, 12,  0,  9, 11,  0, 13,  9],
        #        [12, 10,  6, 12,  2,  3,  7,  3,  3,  3,  6,  1,  2,  6,  6, 10,
        #          2,  3,  2, 11,  2,  5,  7, 12,  5,  8, 13,  2,  0,  3],
        #        [ 9,  6,  1,  0,  6,  3, 11,  1, 12, 12,  6,  9,  8, 11,  4,  3,
        #          0,  9, 13,  5,  7,  2,  6, 12,  0, 10,  8, 10,  4,  6]])
